...
- THEN the default is used for that key, other keys are honored, and a one-line warning is printed once
...
- THEN the file is moved aside, a fresh state is created, and the user sees one line explaining what happened
